...
public class VPedido extends JFrame {
	...
	public VPedido() {
		...
		JLabel lblPrecioGastoEnvio = new JLabel(Double.toString(Principal.selectedRest.getGastosEnvio())+" €");
		...
		JLabel lblPreciototal = new JLabel(Double.toString(Principal.pedidoEnCurso.getCantidad()+Principal.selectedRest.getGastosEnvio())+" €");
		    ...
		    public void mouseClicked(MouseEvent evt) {
		    	try{
		    		if (evt.getClickCount() == 2) {
			    		...
			    		lblPreciototal.setText(Double.toString(Principal.pedidoEnCurso.getCantidad()+Principal.selectedRest.getGastosEnvio())+" €");
			    	}
